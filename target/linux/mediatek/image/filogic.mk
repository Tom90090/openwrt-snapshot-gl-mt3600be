...
define Device/glinet_gl-mt3600be
  ...
  DEVICE_PACKAGES := mt7987-2p5g-phy-firmware kmod-mt7990-firmware kmod-hwmon-pwmfan luci opkg strongswan-full xl2tpd ppp-mod-pppol2tp kmod-l2tp kmod-pppol2tp luci-proto-ppp luci-theme-argon luci-i18n-base-zh-cn luci-i18n-package-manager-zh-cn luci-i18n-firewall-zh-cn nftables-json wireguard-tools kmod-wireguard luci-proto-wireguard qrencode libqrencode luci-lua-runtime luci-compat luci-lib-ipkg lua kmod-usb3 kmod-usb-xhci-mtk kmod-usb-storage kmod-usb-storage-uas block-mount kmod-fs-ext4 kmod-fs-vfat kmod-nls-cp437 kmod-nls-iso8859-1 kmod-usb-net kmod-usb-net-rndis kmod-usb-net-cdc-ether kmod-usb-net-cdc-ncm kmod-usb-net-cdc-mbim kmod-usb-net-qmi-wwan kmod-usb-net-huawei-cdc-ncm kmod-usb-wdm kmod-usb-serial kmod-usb-serial-wwan kmod-usb-serial-option umbim uqmi comgt comgt-ncm usb-modeswitch
  UBINIZE_OPTS := -E 5
  BLOCKSIZE := 128k
  PAGESIZE := 2048
ifeq ($(IB),)
